...
export function extractRetryAfterSeconds(message: string | undefined, fallbackSeconds = 60) {
...
export function getSecondsRemaining(untilMs: number | null | undefined, nowMs = Date.now()) {
  if (!untilMs) return 0;
